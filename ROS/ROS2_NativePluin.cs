...
{
    public unsafe class ROS2_NativePluin
    {
        #region Native Functions
        #region Log
        const string NativePluginName = "autoware_sim_ros2";
        ...
        #endregion
        [DllImport(NativePluginName)]
        public static extern void ros_init([MarshalAs(UnmanagedType.LPStr)] string name);
        [DllImport(NativePluginName)]
